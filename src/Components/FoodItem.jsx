...
const FoodItem = ({ item, quantities, dispatch }) => {
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <span className="text-lg font-semibold text-gray-800">
          {capitalizeWords(item.menu)} {/* Capitalized food name */}
          <span className="text-sm text-gray-600 block">{item["energy (kcal)"]} kcal</span>
        </span>
      </div>
